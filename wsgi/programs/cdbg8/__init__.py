...
var body_id = three_plane_assembly(session, assembly, transf, -1, 1, "part0001.prt", "ASM_FRONT", "ASM_TOP", "ASM_RIGHT", "FRONT", "TOP", "RIGHT");
 
var arm_right_id = axis_plane_assembly(session, assembly, transf, body_id, 2, "part0002.prt", "A_14", "DTM1", "A_9", "TOP");
