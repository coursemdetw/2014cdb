...
import programs.cdbg2.oldham as cdbg2_oldham
# 加入 cdbg2 模組下的 oldham.py 且以子模組 oldham 對應其 oldham() 類別
root.cdbg2.oldham = cdbg2_oldham.oldham()

# 完成設定後, 可以利用
/cdbg2/oldham/assembly
# 呼叫 oldham.py 中 oldham 類別的 assembly 方法
'''
class oldham(object):
    ...
    def index(self, *args, **kwargs):
        outstring = '''
這是 2014CDB 協同專案下的 cdbg2 模組下的 oldham 類別.<br /><br />
<!-- 這裡採用相對連結, 而非網址的絕對連結 (這一段為 html 註解) -->
<a href="assembly">執行  oldham 類別中的 assembly 方法</a><br /><br />
請確定下列零件於 V:/home/oldham/man 目錄中, 且開啟空白 Creo 組立檔案.<br />
<a href="/static/oldham_man.7z">oldham_man.7z</a>(滑鼠右鍵存成 .7z 檔案)<br />
'''
        return outstring
...
var descr = pfcCreate("pfcModelDescriptor").CreateFromFileName ("v:/home/oldham/"+part2);
...
var featID = three_plane_assembly(session, assembly, transf, 0, 0, "03-design_skel.prt", "ASM_TOP", "ASM_FRONT", "ASM_RIGHT", "TOP", "FRONT", "RIGHT"); 
axis_plane_assembly(session, assembly, transf, featID, 0, "03-cam_pin.prt", "A_7", "DTM1", "A_2", "FRONT");
axis_plane_assembly(session, assembly, transf, featID, 0, "03-wheel.prt", "A_8", "DTM1", "A_1", "DTM1");
