...
class CDBG15(object):
    ...
    def index(self, *args, **kwargs):
        outstring = '''
這是 2014CDB 協同專案下的 cdbg15 分組程式開發網頁, 以下為 W12 的任務執行內容.<br />
<!-- 這裡採用相對連結, 而非網址的絕對連結 (這一段為 html 註解) -->
<a href="cube1">cdbg15 正方體參數繪圖</a>(尺寸變數 a, b, c)<br /><br />
...
<a href="cube2">cdbg15 正方體參數繪圖</a>(尺寸變數 a, b, c)<br /><br />
這是 2014CDBG15的第十二週第二小題作業，請輸入以下參數.<br />
<form action="cube2">
